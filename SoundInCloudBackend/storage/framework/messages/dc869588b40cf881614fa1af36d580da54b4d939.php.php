        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-body login-form">
                    <form id="register-form" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('firstname') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="firstname" value="<?php echo e(old('firstname')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('lastname') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="lastname" value="<?php echo e(old('lastname')); ?>" required autofocus>
                        ...
                        <div class="form-group">
                            <label for="gender" class="col-md-4 control-label"><?php echo e(__('Gender')); ?></label>
